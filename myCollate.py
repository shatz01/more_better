...
class BetterBaseCollateFunction(nn.Module):
    ...
    def __init__(self, transform: torchvision.transforms.Compose):
        ...
        super(BetterBaseCollateFunction, self).__init__()
    ...
    def forward(self, batch: List[tuple]):
        ...
        return  originals, transforms, labels, fnames


class BetterImageCollateFunction(BetterBaseCollateFunction):
    ...
    def __init__(self,
        ...
        super(BetterImageCollateFunction, self).__init__(transform)


class BetterSimCLRCollateFunction(BetterImageCollateFunction):
    ...
    def __init__(self,
        ...
        super(BetterSimCLRCollateFunction, self).__init__(
...
class BetterMoCoCollateFunction(BetterImageCollateFunction):
    ...
    def __init__(self,
        ...
        super(BetterMoCoCollateFunction, self).__init__(
            input_size=input_size,
            cj_prob=cj_prob,
